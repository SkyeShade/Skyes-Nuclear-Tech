...
public final class CopperWireConstants {
    ...
    public static final int STEEL_MAX_SAFE_TRANSFER_RJ_PER_TICK = 256;
    public static final double STEEL_MAX_CURRENT_A = 8.0D;
    public static final double STEEL_VOLTAGE_DROP_PER_BLOCK = 2.0D;
