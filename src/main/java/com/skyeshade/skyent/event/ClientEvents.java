...
import com.skyeshade.skyent.client.renderer.blockentity.ArcFurnaceRenderer;
...
import com.skyeshade.skyent.client.screen.*;
...
public final class ClientEvents {
    ...
    public static void onRegisterMenuScreens(RegisterMenuScreensEvent event) {
        ...
        event.register(ModMenus.ARC_FURNACE.get(), ArcFurnaceScreen::new);
        event.register(ModMenus.STEEL_CRATE.get(), SteelCrateScreen::new);
        event.register(ModMenus.STAINLESS_STEEL_CRATE.get(), StainlessSteelCrateScreen::new);
    ...
    public static void onRegisterAdditionalModels(ModelEvent.RegisterAdditional event) {
        ...
        event.register(ArcFurnaceRenderer.BASE_MODEL);
        event.register(ArcFurnaceRenderer.ELECTRODE_1_MODEL);
        event.register(ArcFurnaceRenderer.ELECTRODE_2_MODEL);
        event.register(ArcFurnaceRenderer.ELECTRODE_3_MODEL);
        event.register(ArcFurnaceRenderer.ELECTRODE_3_TOPS_MODEL);
        event.register(ArcFurnaceRenderer.ELECTRODE_HOT_MODEL);
