...
public final class ModCreativeTabs {
    ...
    private static void addMachinesAndTools(CreativeModeTab.Output output) {
        add(output,
                ...
                ModItems.CENTRIFUGE,
                ModItems.ARC_FURNACE,
                ModItems.STEEL_CRATE,
                ModItems.STAINLESS_STEEL_CRATE,
                ModItems.TUNGSTEN_ELECTRODE,
                ModItems.GRAPHITE_ELECTRODE,
                ModItems.BLAST_DOOR,
                ModItems.ZONE_GATE,
                ...
                ModItems.INSULATED_COPPER_CABLE,
                ModItems.COPPER_CABLE_BLOCK,
                ModItems.BRICKED_COPPER_CABLE,
                ModItems.REINFORCED_COPPER_CABLE,
                ModItems.TUNGSTEN_REINFORCED_COPPER_CABLE,
                ModItems.PLATED_COPPER_CABLE,
    ...
    private static void addBlocks(CreativeModeTab.Output output) {
        add(output,
                ...
                ModItems.CHROMITE_ORE,
                ModItems.DEEPSLATE_CHROMITE_ORE,
    ...
    private static void addMaterials(CreativeModeTab.Output output) {
        add(output,
                ...
                ModItems.STAINLESS_STEEL_INGOT,
                ...
                ModItems.RAW_CHROMITE,
                ModItems.CRUSHED_CHROMITE,
                ModItems.RAW_TITANIUM,
                ModItems.RAW_TUNGSTEN,
                ModItems.SULFUR,
                ModItems.FLUORITE_CRYSTAL,
                ModItems.FLUORITE_POWDER,
                ModItems.CARBON_POWDER,
                ModItems.GRAPHITE,
                ModItems.YELLOWCAKE,
                ModItems.LITHIUM_SALTS,
                ModItems.RAW_LEAD,
                ...
                ModItems.STAINLESS_STEEL_PLATE,
                ModItems.GOLD_PLATE,
                ModItems.LEAD_PLATE,
                ModItems.IRON_ROD,
                ModItems.COPPER_ROD,
