...
public class StainlessSteelCrateScreen extends AbstractContainerScreen<StainlessSteelCrateMenu> {
    ...
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(
            ...
            "textures/gui/stainless_steel_crate.png"
    );

    public StainlessSteelCrateScreen(StainlessSteelCrateMenu menu, Inventory playerInventory, Component title) {
        super(menu, playerInventory, title);
        imageWidth = GUI_WIDTH;
        imageHeight = GUI_HEIGHT;
        inventoryLabelY = StainlessSteelCrateMenu.PLAYER_INVENTORY_Y - 11;
    }
    @Override
