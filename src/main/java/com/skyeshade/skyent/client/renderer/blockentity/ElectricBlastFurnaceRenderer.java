...
public class ElectricBlastFurnaceRenderer implements BlockEntityRenderer<ElectricBlastFurnaceBlockEntity> {
    public static final ModelResourceLocation BASE_MODEL = ModelResourceLocation.standalone(
            ResourceLocation.fromNamespaceAndPath(SkyesNuclearTech.MOD_ID, "block/electric_blast_furnace")
    );
    public static final ModelResourceLocation ELECTRODE_1_MODEL = electrodeModel("electric_blast_furnace_electrodes_1");
    public static final ModelResourceLocation ELECTRODE_2_MODEL = electrodeModel("electric_blast_furnace_electrodes_2");
    public static final ModelResourceLocation ELECTRODE_3_MODEL = electrodeModel("electric_blast_furnace_electrodes_3");
    public static final ModelResourceLocation ELECTRODE_3_TOPS_MODEL = electrodeModel("electric_blast_furnace_electrodes_3_tops");
    public static final ModelResourceLocation ELECTRODE_HOT_MODEL = electrodeModel("electric_blast_furnace_electrodes_hot");
    ...
    public ElectricBlastFurnaceRenderer(BlockEntityRendererProvider.Context context) {
    }

    @Override
    public void render(ElectricBlastFurnaceBlockEntity furnace, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        Direction facing = state.hasProperty(ElectricBlastFurnaceBlock.FACING) ? state.getValue(ElectricBlastFurnaceBlock.FACING) : Direction.NORTH;
        int sharedLight = HeatingChamberLighting.computeMaxPackedLight(
                furnace.getLevel(),
                furnace.getBlockPos(),
                facing,
                ElectricBlastFurnaceBlock.SIZE_X,
                ElectricBlastFurnaceBlock.SIZE_Y,
                ElectricBlastFurnaceBlock.SIZE_Z,
                ElectricBlastFurnaceBlock::localToWorld
        );
    ...
    @Override
    public boolean shouldRenderOffScreen(ElectricBlastFurnaceBlockEntity blockEntity) {
        return true;
    }
